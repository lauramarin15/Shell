...
| `crear` | `<archivo>` | Crea un archivo | `crear archivo` |
| `eliminar` | `<archivo>` | Elimina un archivo | `eliminar archivo` |
| `renombrar` | `<archivo>` | Renombra un archivo | `renombrar viejo nuevo` |
